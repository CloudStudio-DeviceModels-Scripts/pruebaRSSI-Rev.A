...
# Parsing + Configuration Script – pruebaRSSI - Rev. A

This **Parsing + Configuration** script is designed for the **pruebaRSSI** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – pruebaRSSI Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **pruebaRSSI** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
